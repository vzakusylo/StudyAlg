...
namespace conc_dict_avoid_race_cond_intro
{
    // https://app.pluralsight.com/course-player?clipId=9d7fb670-72df-491f-8cc9-d4deb977a6d7
    [TestClass]
    ...
    public class StockController
    {
        ...
        public TShirt SelectRandomShirt()
        {
            ...
            return null; //_stock[selectedCode];
        }
